...
<h2 style="color:white;">{$_('leaderboards.list_points', { values: { lp: TopPlayerInfo.LP } })}</h2>
...
<style>
    ...
    #songs { text-align: left; margin: auto; padding: 0px 100px; padding-bottom: 64px; max-width: 900px; }
